( () => {
    var t = {
            ...
            !function(t) {
                ...
                const y = new Set
                  ...
                  , w = t => {
                    if ("hidden" === document.visibilityState) {
                        if ("visibilitychange" === t.type)
                            for (const t of y)
                                t();
                        isFinite(h) || (h = "visibilitychange" === t.type ? t.timeStamp : 0,
                  ...
                  , L = (t, e={}) => {
                    S( () => {
                        ...
                        o && (r = d(t, i, E, e.reportAllChanges),
                        u(n => {
                            i = g("FCP"),
                            r = d(t, i, E, e.reportAllChanges),
                            f( () => {
                ...
                class R {
                    ...
                    u(t) {
                        ...
                        if (n || this.l.length < 10 || t.duration > e.T) {
                            if (n ? t.duration > n.T ? (n.entries = [t],
                            n.T = t.duration) : t.duration === n.T && t.startTime === n.entries[0].startTime && n.entries.push(t) : (n = {
                                id: t.interactionId,
                                entries: [t],
                                T: t.duration
                            },
                        ...
                        L(v( () => {
                            ...
                            const s = a(n, e)
                              , c = t => {
                                for (const e of t)
                                    s.u(e);
                                s.o > o.value && (o.value = s.o,
                                o.entries = s.i,
                                i())
                            }
                              , l = m("layout-shift", c);
                            l && (i = d(t, o, D, n.reportAllChanges),
                            r.onHidden( () => {
                                c(l.takeRecords()),
                                i(!0)
                            }
                ...
                t.onINP = (t, e={}) => {
                    ...
                    const v = () => {
                      ...
                      , h = () => {
                        ...
                        i = i.filter(t => t.startTime > c || r.has(t)),
                        p = !1
                    }
                    ;
                    n.p = t => {
                        ...
                        for (let i = s.length - 1; i >= 0; i--) {
                            ...
                            if (Math.abs(n - o.renderTime) <= 8) {
                                r = o,
                                r.startTime = Math.min(t.startTime, r.startTime),
                                r.processingStart = Math.min(t.processingStart, r.processingStart),
                                r.processingEnd = Math.max(t.processingEnd, r.processingEnd),
                                !1 !== e.includeProcessedEventEntries && r.entries.push(t);
                                break
                            }
                        }
                        r || (r = {
                        ...
                        s.push(r)),
                        (t.interactionId || "first-input" === t.entryType) && l.set(t, r),
                        v()
                    }
                    ,
                    n.m = t => {
                ...
                t.onTTFB = (t, e={}) => {
                    ( (t, e={}) => {
                        ...
                        q( () => {
                            const o = n();
                            o && (r.value = Math.max(o.responseStart - p(), 0),
                            r.entries = [o],
                            i(!0),
                            u( () => {
                                r = g("TTFB", 0),
        ...
        674: (t, e) => {
            ...
            e.timingsV2TargetKeys = e.timingsTargetKeys = void 0,
            e.buildTimingsObject = function(t, e, n) {
                for (const r of n) {
                    const n = t[r];
            ...
            ,
            e.timingsTargetKeys = ["navigationStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domComplete", "loadEventStart", "loadEventEnd"],
            e.timingsV2TargetKeys = ["nextHopProtocol", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domInteractive", "domComplete", "loadEventStart", "loadEventEnd", "finalResponseHeadersStart", "firstInterimResponseStart", "transferSize", "decodedBodySize"]
        }
        ,
        696: (t, e) => {
            "use strict";
        ...
        791: (t, e, n) => {
            ...
            function m(t, e, n, r, i, o, s=0) {
                ...
                null != e || (e = Date.now()),
                null != n || (n = 0),
                null != r || (r = 16383 & (t[8] << 8 | t[9])),
                null != i || (i = t.slice(10, 16));
            ...
            const v = function(t, e, n) {
                ...
                if (t)
                    a = m(null !== (s = null !== (i = t.random) && void 0 !== i ? i : null === (o = t.rng) || void 0 === o ? void 0 : o.call(t)) && void 0 !== s ? s : p(), t.msecs, t.nsecs, t.clockseq, t.node, e, n);
                else {
                    const t = Date.now()
                      , r = p();
                    !function(t, e, n) {
                        var r, i;
                        null !== (r = t.msecs) && void 0 !== r || (t.msecs = -1 / 0),
                        null !== (i = t.nsecs) && void 0 !== i || (t.nsecs = 0),
                        e === t.msecs ? (t.nsecs++,
                        t.nsecs >= 1e4 && (t.node = void 0,
                        t.nsecs = 0)) : e > t.msecs ? t.nsecs = 0 : e < t.msecs && (t.node = void 0),
                        t.node || (t.node = n.slice(10, 16),
                        t.node[0] |= 1,
                        t.clockseq = 16383 & (n[8] << 8 | n[9])),
                        t.msecs = e
                    }(g, t, r),
                    a = m(r, g.msecs, g.nsecs, c ? void 0 : g.clockseq, c ? void 0 : g.node, e, n)
                }
                return null != e ? e : l(a)
            };
            function h(t) {
                ...
                return function(t) {
                    ...
                    for (let e = 0; e < t.length; e += 16) {
                        const n = r
                          ...
                          , c = o
                          , l = s;
                        r = b(r, i, o, s, t[e], 7, -680876936),
                        s = b(s, r, i, o, t[e + 1], 12, -389564586),
                        o = b(o, s, r, i, t[e + 2], 17, 606105819),
                        i = b(i, o, s, r, t[e + 3], 22, -1044525330),
                        r = b(r, i, o, s, t[e + 4], 7, -176418897),
                        s = b(s, r, i, o, t[e + 5], 12, 1200080426),
                        o = b(o, s, r, i, t[e + 6], 17, -1473231341),
                        i = b(i, o, s, r, t[e + 7], 22, -45705983),
                        r = b(r, i, o, s, t[e + 8], 7, 1770035416),
                        s = b(s, r, i, o, t[e + 9], 12, -1958414417),
                        o = b(o, s, r, i, t[e + 10], 17, -42063),
                        i = b(i, o, s, r, t[e + 11], 22, -1990404162),
                        r = b(r, i, o, s, t[e + 12], 7, 1804603682),
                        s = b(s, r, i, o, t[e + 13], 12, -40341101),
                        o = b(o, s, r, i, t[e + 14], 17, -1502002290),
                        i = b(i, o, s, r, t[e + 15], 22, 1236535329),
                        r = S(r, i, o, s, t[e + 1], 5, -165796510),
                        s = S(s, r, i, o, t[e + 6], 9, -1069501632),
                        o = S(o, s, r, i, t[e + 11], 14, 643717713),
                        i = S(i, o, s, r, t[e], 20, -373897302),
                        r = S(r, i, o, s, t[e + 5], 5, -701558691),
                        s = S(s, r, i, o, t[e + 10], 9, 38016083),
                        o = S(o, s, r, i, t[e + 15], 14, -660478335),
                        i = S(i, o, s, r, t[e + 4], 20, -405537848),
                        r = S(r, i, o, s, t[e + 9], 5, 568446438),
                        s = S(s, r, i, o, t[e + 14], 9, -1019803690),
                        o = S(o, s, r, i, t[e + 3], 14, -187363961),
                        i = S(i, o, s, r, t[e + 8], 20, 1163531501),
                        r = S(r, i, o, s, t[e + 13], 5, -1444681467),
                        s = S(s, r, i, o, t[e + 2], 9, -51403784),
                        o = S(o, s, r, i, t[e + 7], 14, 1735328473),
                        i = S(i, o, s, r, t[e + 12], 20, -1926607734),
                        r = E(r, i, o, s, t[e + 5], 4, -378558),
                        s = E(s, r, i, o, t[e + 8], 11, -2022574463),
                        o = E(o, s, r, i, t[e + 11], 16, 1839030562),
                        i = E(i, o, s, r, t[e + 14], 23, -35309556),
                        r = E(r, i, o, s, t[e + 1], 4, -1530992060),
                        s = E(s, r, i, o, t[e + 4], 11, 1272893353),
                        o = E(o, s, r, i, t[e + 7], 16, -155497632),
                        i = E(i, o, s, r, t[e + 10], 23, -1094730640),
                        r = E(r, i, o, s, t[e + 13], 4, 681279174),
                        s = E(s, r, i, o, t[e], 11, -358537222),
                        o = E(o, s, r, i, t[e + 3], 16, -722521979),
                        i = E(i, o, s, r, t[e + 6], 23, 76029189),
                        r = E(r, i, o, s, t[e + 9], 4, -640364487),
                        s = E(s, r, i, o, t[e + 12], 11, -421815835),
                        o = E(o, s, r, i, t[e + 15], 16, 530742520),
                        i = E(i, o, s, r, t[e + 2], 23, -995338651),
                        r = L(r, i, o, s, t[e], 6, -198630844),
                        s = L(s, r, i, o, t[e + 7], 10, 1126891415),
                        o = L(o, s, r, i, t[e + 14], 15, -1416354905),
                        i = L(i, o, s, r, t[e + 5], 21, -57434055),
                        r = L(r, i, o, s, t[e + 12], 6, 1700485571),
                        s = L(s, r, i, o, t[e + 3], 10, -1894986606),
                        o = L(o, s, r, i, t[e + 10], 15, -1051523),
                        i = L(i, o, s, r, t[e + 1], 21, -2054922799),
                        r = L(r, i, o, s, t[e + 8], 6, 1873313359),
                        s = L(s, r, i, o, t[e + 15], 10, -30611744),
                        o = L(o, s, r, i, t[e + 6], 15, -1560198380),
                        i = L(i, o, s, r, t[e + 13], 21, 1309151649),
                        r = L(r, i, o, s, t[e + 4], 6, -145523070),
                        s = L(s, r, i, o, t[e + 11], 10, -1120210379),
                        o = L(o, s, r, i, t[e + 2], 15, 718787259),
                        i = L(i, o, s, r, t[e + 9], 21, -343485551),
                        r = T(r, n),
                        i = T(i, a),
                        o = T(o, c),
                        s = T(s, l)
            ...
            const B = function(t) {
                ...
                for (let e = 0; e < o; ++e) {
                    ...
                    for (let r = 0; r < 16; ++r)
                        n[r] = t[64 * e + 4 * r] << 24 | t[64 * e + 4 * r + 1] << 16 | t[64 * e + 4 * r + 2] << 8 | t[64 * e + 4 * r + 3];
                    s[e] = n
                }
                ...
                for (let t = 0; t < o; ++t) {
                    ...
                    for (let e = 0; e < 16; ++e)
                        r[e] = s[t][e];
                    for (let t = 16; t < 80; ++t)
                        r[t] = R(r[t - 3] ^ r[t - 8] ^ r[t - 14] ^ r[t - 16], 1);
                    let i = n[0]
                      , o = n[1]
                      , a = n[2]
                      , c = n[3]
            ...
            function F(t) {
                const e = (n = "string" == typeof t ? a(t) : t,
                Uint8Array.of((15 & n[3]) << 4 | n[4] >> 4 & 15, (15 & n[4]) << 4 | (240 & n[5]) >> 4, (15 & n[5]) << 4 | 15 & n[6], n[7], (15 & n[1]) << 4 | (240 & n[2]) >> 4, (15 & n[2]) << 4 | (240 & n[3]) >> 4, 16 | (240 & n[0]) >> 4, (15 & n[0]) << 4 | (240 & n[1]) >> 4, n[8], n[9], n[10], n[11], n[12], n[13], n[14], n[15]));
                var n;
                return "string" == typeof t ? l(e) : e
            }
            const q = {};
            function N(t, e, n, r, i=0) {
                ...
                null != n || (n = 127 * t[6] << 24 | t[7] << 16 | t[8] << 8 | t[9]),
                r[i++] = e / 1099511627776 & 255,
                r[i++] = e / 4294967296 & 255,
                r[i++] = e / 16777216 & 255,
                r[i++] = e / 65536 & 255,
                r[i++] = e / 256 & 255,
                r[i++] = 255 & e,
            ...
            const V = function(t, e, n) {
                ...
                let s;
                if (t)
                    s = N(null !== (o = null !== (r = t.random) && void 0 !== r ? r : null === (i = t.rng) || void 0 === i ? void 0 : i.call(t)) && void 0 !== o ? o : p(), t.msecs, t.seq, e, n);
                else {
                    const t = Date.now()
                      , r = p();
                    !function(t, e, n) {
                        var r, i;
                        null !== (r = t.msecs) && void 0 !== r || (t.msecs = -1 / 0),
                        null !== (i = t.seq) && void 0 !== i || (t.seq = 0),
                        e > t.msecs ? (t.seq = n[6] << 23 | n[7] << 16 | n[8] << 8 | n[9],
                        t.msecs = e) : (t.seq = t.seq + 1 | 0,
                        0 === t.seq && t.msecs++)
                    }(q, t, r),
                    s = N(r, q.msecs, q.seq, e, n)
                }
                return null != e ? e : l(s)
            }
              , $ = function(t) {
    ...
    ( () => {
        ...
        ( () => {
            ...
            !function() {
                ...
                let l, u, d = (0,
                i.v4)(), f = [], p = window.__cfBeacon ? window.__cfBeacon : {};
                if (p && "single" === p.load)
                    return;
                if (c) {
                ...
                function T(t) {
                    ...
                    let c;
                    switch (m || (m = t.navigationType),
                    "INP" !== t.name && (y[t.name.toLowerCase()] = {
                        value: t.value,
                        path: a
                    }),
                    t.name) {
                    case "CLS":
                        c = t.attribution,
                        c && y.cls && (y.cls.element = c.largestShiftTarget,
                        y.cls.currentRect = null === (e = c.largestShiftSource) || void 0 === e ? void 0 : e.currentRect,
                        y.cls.previousRect = null === (n = c.largestShiftSource) || void 0 === n ? void 0 : n.previousRect);
                        break;
                    case "LCP":
                        c = t.attribution,
                        c && y.lcp && (y.lcp.element = c.target,
                        y.lcp.size = null === (r = c.lcpEntry) || void 0 === r ? void 0 : r.size,
                        y.lcp.url = c.url,
                        y.lcp.rld = c.resourceLoadDelay,
                        y.lcp.rlt = c.resourceLoadDuration,
                        y.lcp.erd = c.elementRenderDelay,
                        y.lcp.it = null === (i = c.lcpResourceEntry) || void 0 === i ? void 0 : i.initiatorType,
                        y.lcp.fp = null === (s = null === (o = c.lcpEntry) || void 0 === o ? void 0 : o.element) || void 0 === s ? void 0 : s.getAttribute("fetchpriority"));
                        break;
                    case "INP":
                        ...
                        c = t.attribution,
                        c && y.inp && (y.inp.element = c.interactionTarget,
                        y.inp.name = c.interactionType,
                        y.inp.idy = c.inputDelay,
                        y.inp.pdn = c.processingDuration,
                        y.inp.pdy = c.presentationDelay))
                    }
                }
                ...
                document.addEventListener("visibilitychange", () => {
                    if ("hidden" === document.visibilityState) {
                        if (w && D()) {
                            const t = n();
                            (null == g ? void 0 : g.url) == t && (null == g ? void 0 : g.triggered) || S(),
                            A(t)
                        }
                        !v && g && (v = !0,
                        E())
                    } else
                        "visible" === document.visibilityState && (h = (new Date).getTime())
                }
                );
                const w = p && (void 0 === p.spa || !0 === p.spa)
                        ...
                        if (null == l) {
                            if ("function" == typeof s.getEntriesByType) {
                                ...
                                if (t && Array.isArray(t) && t.length > 0) {
                                    c.timingsV2 = {},
                                    c.versions.timings = 2,
                                    c.dt = t[0].deliveryType,
                                    delete c.timings;
                                    const e = t[0];
                                    (0,
                                    o.buildTimingsObject)(e, c.timingsV2, o.timingsV2TargetKeys)
                                }
                            }
                            if (1 === c.versions.timings) {
                                const t = r;
                                c.timings && (0,
                                o.buildTimingsObject)(t, c.timings, o.timingsTargetKeys)
                            }
                            !function(t, e) {
                                for (const n in t) {
                                    const r = t[n];
                            ...
                            I(c);
                        return c.firstPaint = M("first-paint"),
                        c.firstContentfulPaint = M("first-contentful-paint"),
                        p && (p.icTag && (c.icTag = p.icTag),
                        c.siteToken = p.token),
                        void 0 !== l && (delete c.timings,
                        delete c.memory),
                        c
                    }(r);
                    i && p && (i.resources = [],
                  ...
                  , E = () => {
                    let r = function() {
                        ...
                        return p && (p.version && (i.versions.fl = p.version),
                        p.icTag && (i.icTag = p.icTag),
                        i.siteToken = p.token),
                        y && ["lcp", "cls", "fcp", "ttfb", "inp"].forEach(t => {
                            i[t] = {
                                value: -1,
                                path: void 0
                            },
                ...
                function U() {
                    ...
                    for (const e of ["navigation", "resource"])
                        for (const {name: n, serverTiming: r} of s.getEntriesByType(e))
                            if (r) {
                                if ("resource" === e) {
                                ...
                                for (const {name: i, description: o, duration: s} of r)
                                    if (p.serverTiming.name && p.serverTiming.name[i])
                                        try {
                                            const r = new URL(n);
                                            t.push({
                ...
                function I(t) {
                    if ("function" == typeof s.getEntriesByType) {
                        ...
                        let n = {};
                        t.timingsV2 = {},
                        e && e[0] && (e[0].nextHopProtocol && (n.nextHopProtocol = e[0].nextHopProtocol),
                        e[0].transferSize && (n.transferSize = e[0].transferSize),
                        e[0].decodedBodySize && (n.decodedBodySize = e[0].decodedBodySize),
                        t.dt = e[0].deliveryType),
                        (0,
                        o.buildTimingsObject)(n, t.timingsV2, o.timingsV2TargetKeys)
                    }
                }
                function M(t) {
                    var e;
                    if ("first-contentful-paint" === t && y.fcp && y.fcp.value)
                        return y.fcp.value;
                    if ("function" == typeof s.getEntriesByType) {
                ...
                (t => {
                    ...
                    if (e) {
                        ...
                        t.pushState = function(i, o, s) {
                            ...
                            let c = !0;
                            return l == a && (c = !1),
                            c && (D() && ((null == g ? void 0 : g.url) == a && (null == g ? void 0 : g.triggered) || S(a),
                            A(a)),
                            r()),
                            e.apply(t, [i, o, s])
                        }
                        ...
                        window.addEventListener("popstate", function(t) {
                            D() && ((null == g ? void 0 : g.url) == l && (null == g ? void 0 : g.triggered) || S(l),
                            A(l)),
                            l = n(),
                            r()
                        })
